...
class EditProfileWidgetState extends State<EditProfileWidget>
                                                ...
                                                Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    ...
                                                    image: (_imageFile!.path ==
                                                            '')
                                                        ? DecorationImage(
                                                            image: CachedNetworkImageProvider((authenticationState
                                                                        .profile!
                                                                        .avatar ==
                                                                    '')
  ...
  Future<bool> updatePersonalInformation(
    ...
    return await _profileService.updatePersonalInformation(
        id, name, gender, '');
  }
